...
export default function ForgotPassword({ onSwitchToSignIn, onClose }: ForgotPasswordProps) {
  ...
  if (success) {
    return (
      <Modal isOpen onClose={onClose} title="Check Your Email" panelClassName="max-w-md w-full">
        <div className="relative -m-6 p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              We&apos;ve sent a password reset link to <strong>{email}</strong>. Please check your email and click the
              link to reset your password.
            </p>

            <div className="space-y-3">
              <button type="button" onClick={handleBackToSignIn} className="w-full btn-primary">
                Back to Sign In
              </button>
  ...
  return (
    <Modal isOpen onClose={onClose} title="Reset Password" panelClassName="max-w-md w-full">
      <div className="relative -m-6 p-6">
        <p className="text-gray-600 mb-6">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <button type="button" onClick={handleBackToSignIn} className="btn-text">
              Back to Sign In
            </button>
          </p>
        </div>
